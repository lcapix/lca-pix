...
async function loadCase2CostData() {
  console.log('🚀 Loading Cost Data for Case 2...\n');
  ...
  try {
    // Read SQL file
    const sqlPath = path.join(__dirname, 'add-case2-cost-data.sql');
    ...
    // Execute SQL
    console.log('⚙️  Updating Case 2 components with cost data...\n');
    ...
    console.log(`\n📊 Updated ${components.length} components in Case 2:\n`);
    ...
    console.log('🎉 Case 2 Cost Data Loading Complete!\n');
