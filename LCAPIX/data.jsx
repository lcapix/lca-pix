// data.jsx — demo data for LCAPIX prototype

const DEMO_USER = { name: 'Kavish', initials: 'KP', email: 'kavish@example.com' };
...
// Cases for the EV project (primary demo)
const DEMO_CASES = [
  {
    id: 'baseline-2025',
    projectId: 'ev-mfg',
...
// Tree hierarchy for Baseline Production 2025
const DEMO_TREE = {
  id: 'p1', type: 'Product', label: 'NMC Battery Pack (60 kWh)',
  flows: 2, cost: 8420,
  children: [
    {
      id: 'm1', type: 'Machine', label: 'Cell Production Line',
      flows: 4, cost: 3240,
      children: [
        {
          id: 's1', type: 'Subprocess', label: 'Cathode Coating',
          flows: 3, cost: 980,
          children: [
            {
              id: 'o1', type: 'Operation', label: 'Slurry Mixing',
              flows: 2, cost: 420,
              children: [
            ...
            { id: 'o2', type: 'Operation', label: 'Drying Oven', flows: 3, cost: 560,
              children: [
        ...
        {
          id: 's2', type: 'Subprocess', label: 'Anode Coating',
          flows: 2, cost: 820,
          children: [
            { id: 'o3', type: 'Operation', label: 'Graphite Deposition', flows: 4, cost: 410,
              children: [
    ...
    {
      id: 'm2', type: 'Machine', label: 'Module Assembly',
      flows: 3, cost: 2180,
      children: [
        { id: 's3', type: 'Subprocess', label: 'Cell Stacking', flows: 2, cost: 720,
          children: [
            { id: 'o4', type: 'Operation', label: 'Automated Pick-Place', flows: 3, cost: 380,
              children: [
    ...
    {
      id: 'm3', type: 'Machine', label: 'Pack Integration',
      flows: 3, cost: 1480,
      children: [
...
// Top contributors for EV baseline
...
Object.assign(window, {
  DEMO_USER, DEMO_PROJECTS, DEMO_CASES, DEMO_TREE, DEMO_CONTRIBUTORS, DEMO_CATEGORIES,
  DEMO_FLOWS, DEMO_METHODS, DEMO_RUNS, DEMO_INTEGRATIONS, DEMO_ACTIVITY, HIERARCHY_TYPES,
});
